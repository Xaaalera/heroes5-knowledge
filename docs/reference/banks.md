...
Публичная справка о хранилище описывает **возможные варианты охраны**, а не раскрывает выбранный игрой вариант конкретного объекта. Тиры и альтернативные составы нужно хранить раздельно.
...
## Тайник бесов: исправленный пример
