...
[Данные опытов и хеши исходных снимков](../assets/placement/observations.json) · [Дневник с последовательностью попыток](../reference/research-diary.md#elementals) · [Скачать полигон](../modding/test-maps.md) · [Запустить полигон через devkit](https://github.com/Xaaalera/heroes5-mod-devkit/blob/main/README.md#карта-и-команды-игры).
